...
\node [bigblock, above = 0.7 of input] (backbone) {\textbf{{\larger[2] Backbone}}};
\node [block, dashed, above left = 0.7 and 0.6 of backbone] (outcome) {Outcome Head};
\node [block, above = 0.7 and of backbone] (murmur) {Murmur Head};
\node [block, dashed, above right = 0.7 and 0.6 of backbone] (seg) {Segmentation Head};
\node [text width = 5.5em, text centered, above = 0.7 of outcome] (outcome_pred) {Outcome Prediction};
\node [text width = 5.5em, text centered, above = 0.7 of murmur] (murmur_pred) {Murmur Prediction};
\node [text width = 5.5em, text centered, above = 0.7 of seg] (seg_pred) {Segmentation Prediction};
