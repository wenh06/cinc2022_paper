...
Aim: The George B. Moody PhysioNet Challenge 2022 raised problems of heart murmur detection and related abnormal cardiac function identification from phonocardiogram (PCG) recordings. This work describes the novel approaches developed by our team, Revenger, to these problems.
...
Based on a stratified splitting of the subjects, 20\% of the public data were left out as a validation set for model selection. Each recording was padded or sliced to a length of 30 seconds and a batch size of 24 was used for parallel training. The AdamW optimizer was adopted, along with the OneCycle scheduler with a maximum learning rate of 0.002, to optimize the model weights.
...
Conclusion: We provided a practical solution, which still has improvement spaces, to the problems of detecting heart murmurs and providing clinical diagnosis suggestions from PCGs.
